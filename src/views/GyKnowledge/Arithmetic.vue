<template>
  <div>
    ...
    <el-table v-if="structureListDataNew[0].is_knowledge_point==0" :data="structureListDataNew" style="width: 100%"
      stripe border @row-click="tableRowClick">
      ...
      <el-form :model="form">
        ...
        <div v-if="form.is_knowledge_point==1">
          <el-form-item label="选择知识点分类:">
            ...
            <el-button class="el-icon-plus" @click="addKeyTypeFormVisible = true" style="margin-left:10px">新建
            </el-button>
          </el-form-item>
    ...
    <el-dialog title="新建" v-model="addKeyTypeFormVisible">
      <el-form :model="newKeyTypeForm">
        <el-form-item label="选择分类:">
          <el-cascader v-model="knowledgeType" :options="knowledgeOptions" :props="{ checkStrictly: true }"
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addKeyTypeFormVisible = false,addDataStructureKeyType1()">确 定</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog title="知识详情" v-model="knowledgeDetailPageVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addDataStructure1(1),knowledgeDetailPageVisible = false">保存编辑</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
const getDataStructureList1 = async () => {
  let data: any = await getDataStructureList()
  if (data.data == []) {
    return
  }
...
const addDataStructureKeyType1 = async () => {
  let params = {
    ...
    father_id: newKeyTypeForm.value.newKeyFatherId,
  };
