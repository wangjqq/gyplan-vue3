<template>
  <div style="width: 99.7vw">
    <el-row :gutter="10">
      ...
      <el-col :span="1">
        <el-button type="primary" @click="getAllImsList1(), (chooesType = [])"
          >显示全部</el-button
        >
      </el-col>
    </el-row>
    <p style="font-size: 30px; position: absolute; top: 45px; left: 45%">
      元器件管理系统
    </p>
    <el-table
      :data="ImsList"
    ...
    >
      ...
      >
        <template #default="scope">
          <span>{{
            scope.row.voltage == "" ? "" : scope.row.voltage + "V"
          }}</span>
        </template>
      </el-table-column>
      <el-table-column
      ...
      >
        <template #default="scope">
          <span>{{
            scope.row.electricity == "" ? "" : scope.row.electricity + "A"
          }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog title="添加元器件" v-model="addFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addItem1(ruleFormRef)"
          >确 定</el-button
        >
      </div>
    </el-dialog>
    ...
    <el-dialog title="新建元器件分类" v-model="addTypeVisible">
      <el-form :model="newTypeForm">
        <el-form-item label="选择父级分类:">
          <el-cascader
            v-model="newTypeForm.type_father_id"
            :options="ImsOptions"
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          type="primary"
          @click="(addTypeVisible = false), addItemType1()"
          >确 定</el-button
        >
      </div>
    </el-dialog>
